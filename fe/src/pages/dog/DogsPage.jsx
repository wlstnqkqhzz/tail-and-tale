...
import { initialForm, MAX_DOG_IMAGE_SIZE, MAX_DOG_WEIGHT, WALK_CREATE_NOTICE_KEY, WALK_CREATE_NOTICE_LOCK_KEY } from "../../constants/dogPage";
import { DetailItem, DogAvatar, DogImagePreview, VerifiedBadge } from "../../components/dog/DogPageSections";
import { formatDateTime, formatGender, formatSize, getTodayDate } from "../../utils/dogPage";
