...
public enum CareErrorCode implements BaseErrorCode {
    ...
    WALK_RECORD_NOT_FOUND(HttpStatus.NOT_FOUND, "산책 기록을 찾을 수 없습니다."),                                // 산책 기록 조회 실패
    WALK_RECORD_TIME_INVALID(HttpStatus.BAD_REQUEST, "산책 종료 시간은 시작 시간 이후여야 합니다."),               // 산책 시간 오류
    WALK_RECORD_SCHEDULE_ACCESS_DENIED(HttpStatus.FORBIDDEN, "참여한 산책 일정만 기록에 연결할 수 있습니다."),      // 산책 일정 연결 권한 없음
