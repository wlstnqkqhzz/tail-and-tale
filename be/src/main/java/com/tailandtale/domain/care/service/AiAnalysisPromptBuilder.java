...
public class AiAnalysisPromptBuilder {
    ...
    public String build(
        ...
        prompt.append("""
                ...
                한눈에 볼 수 있도록 3~4줄 이내로 작성한다.

                🔍 이번 %s 발견된 패턴
                발견된 패턴을 bullet 형식으로 작성
                최대 3개
                데이터에 근거하여 설명

                ❤️ 좋아하는 활동 추정
                좋아하는 활동을 bullet 형식으로 작성
                근거를 함께 작성
                ...
                💌 보호자에게 한마디
                보호자가 읽고 기분 좋아질 수 있도록 따뜻한 문체로 2~3문장 작성
