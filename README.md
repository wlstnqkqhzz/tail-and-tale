...
관리자는 신고된 회원, 게시글, 댓글, 채팅 메시지를 확인하고 처리할 수 있으며, 사용자는 차단 기능을 통해 특정 회원의 게시글, 댓글, 산책 모집글, 채팅 상호작용을 제한할 수 있습니다.
...
│   │   ├── constants/                   # 화면 상수 및 라벨
│   │   ├── hooks/                       # 인증 등 커스텀 훅
│   │   ├── pages/                       # 라우팅 페이지
│   │   ├── routes/                      # React Router 설정
│   │   └── utils/                       # 포맷터, 토큰, STOMP 유틸
...
| GET | `/api/walk-schedules` | 산책 모집글 목록 조회 |
...
| GET | `/api/community/posts/{communityPostId}/comments` | 댓글 목록 조회 |
...
| HealthRecord | 건강 상태, 식사, 수면, 특이사항 관리 |
...
- `docs/sql/tail_tale_care_seed.sql`은 케어 기록 비교용 seed 데이터를 포함합니다.
